  ...
  const jobs = [
    {
      ...
      type: "Tempo Integral",
      posted: "2 dias atrás",
      description: "Responsável pela gestão técnica de operações agrícolas em larga escala.",
    },
    {
      id: 2,
      ...
      type: "Tempo Integral",
      posted: "5 dias atrás",
      description: "Coordenação de operações logísticas e gestão de frota de distribuição.",
    },
    {
      id: 3,
      ...
      description: "Supervisão de operações farmacêuticas e garantia de qualidade.",
    },
    {
      id: 4,
